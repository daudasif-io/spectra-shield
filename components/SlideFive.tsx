...
export default function SlideFive({ onNext, onPrev, onShake, accent, isMobile }: SlideProps) {
  ...
  return (
    ...
    >
      <div style={{ maxWidth: isMobile ? "100%" : "420px", width: "100%" }}>
        ...
        >
          Rapid deployment protocols activate the moment a threat threshold is crossed. Autonomous response units are dispatched within minutes, containing contamination and safeguarding personnel before human teams arrive on site.
        </p>
