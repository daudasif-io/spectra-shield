...
export default function SlideThree({ onNext, onPrev, onShake, accent, isMobile }: SlideProps) {
  ...
  return (
    ...
    >
      <div style={{ maxWidth: isMobile ? "100%" : "420px", width: "100%" }}>
        ...
        >
          Continuous environmental surveillance across vast territories. Our sensor networks transmit live radiation telemetry, enabling operators to track anomalies in real time before they become critical incidents.
        </p>
