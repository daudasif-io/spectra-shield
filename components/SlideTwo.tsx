  ...
  return (
    ...
    >
      <div style={{ maxWidth: "420px", width: "100%" }}>
        ...
        >
          Advanced sensor arrays deployed across critical zones allow
          real-time environmental monitoring. Autonomous drones navigate
          complex terrain, transmitting hazard data before human
          intervention is ever required.
        </p>
