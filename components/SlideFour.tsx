...
export default function SlideFour({ onNext, onPrev, onShake, accent, isMobile }: SlideProps) {
  ...
  return (
    ...
    >
      <div style={{ maxWidth: isMobile ? "100%" : "420px", width: "100%" }}>
        ...
        >
          Petabytes of isotope data processed through adaptive machine learning models. Our analysis platform identifies hidden patterns in radiation signatures, delivering actionable intelligence in seconds rather than days.
        </p>
